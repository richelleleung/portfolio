...
function business_architect_help_notice() {
		...
		$demo_msg = __( '1. Get Demo | Upgrade to Pro', 'business-architect');	
...
if ( isset( $_GET['hide_admin_notice'] ) ) {
		update_option('business_architect_hide_admin_notice', 'always-hide');
} else {
	$business_architect_info = get_option('business_architect_hide_admin_notice', 'show');
	if ($business_architect_info != 'always-hide' || $business_architect_info ==""){ 
...
function business_architect_admin_css_add_style() {  

wp_enqueue_style('admin-css-style', get_bloginfo('stylesheet_directory').'/css/admin.css');

}

add_action('admin_enqueue_scripts', 'business_architect_admin_css_add_style');

function business_architect_admin_notice() {			

echo '<div class="service_section"><div class="service_box"><h3>Wordpress Customization Service</h3><p>Add more custom features and designs to improve conversion</p><center><a target="_blank" rel="nofollow noopener" href="https://wpbusinessthemes.com/wordpress-customization-service/" class="learn_more" title="Learn More" data-wpel-link="external">Learn More</a></center></div><div class="service_box"><h3>SEO Services</h3><p>Increase your ranking and traffic through on page and off page services</p><center><a target="_blank" rel="nofollow noopener" href="https://wpbusinessthemes.com/seo-services/" class="learn_more" title="Learn More" data-wpel-link="external">Learn More</a></center></div><div class="service_box"><h3>Content Writing & Virtual Assistant service</h3><p>Consistent content keeps your visitors engaged and drive more traffic</p><center><a target="_blank" rel="nofollow noopener" href="https://wpbusinessthemes.com/content-writing-virtual-assistant-service/" class="learn_more" title="Learn More" data-wpel-link="external">Learn More</a></center></div></div><br/><a href="https://wpbusinessthemes.com/product/agency-starter-theme/" target="_blank"><input type="button" value="Upgrade to Pro, unlock many features" class="button button-primary button-large req_btn"></a>';		

}

add_action('admin_notices', 'business_architect_admin_notice');
